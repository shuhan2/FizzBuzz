...
class FourthFizzBuzzDemoTest {
  ...
  @Test
  void should_return_53_when_fizzBuzz_given_53() {
    String actualResult = new FourthFizzBuzzDemo().fizzBuzz(53);
    assertEquals("53", actualResult);
  }

  @Test
  void should_return_BuzzWhizz_when_fizzBuzz_given_35() {
    String actualResult = new FourthFizzBuzzDemo().fizzBuzz(35);
    assertEquals("BuzzWhizz", actualResult);
  }

  @Test
  void should_return_Fizz_when_fizzBuzz_given_75() {
    String actualResult = new FourthFizzBuzzDemo().fizzBuzz(75);
    assertEquals("Fizz", actualResult);
  }

  @Test
  void should_return_Fizz_when_fizzBuzz_given_73() {
    String actualResult = new FourthFizzBuzzDemo().fizzBuzz(73);
    assertEquals("Fizz", actualResult);
  }
}